		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "PortalProUploadPrilohDodavatele",
									"targetURL": "#zmmvpi01appz20231228mmvpi01-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zmmvpi01appz20231228mmvpi01-display": {
								"semanticObject": "zmmvpi01appz20231228mmvpi01",
								"action": "display",
								"description": "PortalProUploadPrilohDodavatele",
								"title": "PortalProUploadPrilohDodavatele",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zmmvpi01.app.z20231228mmvpi01",
									"url": sap.ui.require.toUrl("zmmvpi01/app/z20231228mmvpi01")
								}
							}
						}
					}
