...
sap.ui.define([
	...
	"sap/m/MenuButton",
	"sap/ui/core/Lib"
], function(Control, Element, KeyCodes, Log, deepEqual, MobileLibrary, Button, 
	Dialog, List, MessageBox, OverflowToolbar, StandardListItem, Text, ToolbarSpacer, 
	FileUploader, UploadSetItem, Uploader, Renderer, UploaderHttpRequestMethod, DragDropInfo, DropInfo,
	 UploadSetToolbarPlaceholder, IllustratedMessage, IllustratedMessageType, IllustratedMessageSize, Core, InvisibleText, Menu, MenuItem, MenuButton, CoreLib) {
	"use strict";
	 ...
	 */
	 var UploadSet = Control.extend("zmmvpi01.app.z20231228mmvpi01.control.UploadSet", {
		metadata: {
			library: "sap.m",
			properties: {
				/**
